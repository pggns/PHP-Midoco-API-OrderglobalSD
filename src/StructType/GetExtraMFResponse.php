...
class GetExtraMFResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoMfForArrayConstraintFromSetMidocoMf(?array $values = []): string
    {
        ...
        foreach ($values as $getExtraMFResponseMidocoMfItem) {
            ...
            if (!$getExtraMFResponseMidocoMfItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoMf) {
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\MidocoMf[] $midocoMf
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetExtraMFResponse
     */
