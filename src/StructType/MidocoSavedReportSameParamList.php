...
class MidocoSavedReportSameParamList extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderglobalSD\StructType\MidocoJasperReportExt $midocoJasperReportExt = null, array $midocoJasperReportParamValue = [])
    {
        $this
