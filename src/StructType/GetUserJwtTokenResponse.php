...
class GetUserJwtTokenResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO[]
     */
     ...
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO[]
     */
    ...
    public static function validateMidocoUserJwtTokenForArrayConstraintFromSetMidocoUserJwtToken(?array $values = []): string
    {
        ...
        foreach ($values as $getUserJwtTokenResponseMidocoUserJwtTokenItem) {
            ...
            if (!$getUserJwtTokenResponseMidocoUserJwtTokenItem instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO[] $midocoUserJwtToken
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetUserJwtTokenResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO $item
     * @return \Pggns\MidocoApi\OrderglobalSD\StructType\GetUserJwtTokenResponse
     */
    public function addToMidocoUserJwtToken(\Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoUserJwtToken property can only contain items of type \Pggns\MidocoApi\OrderglobalSD\StructType\UsersJwtTokenDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
